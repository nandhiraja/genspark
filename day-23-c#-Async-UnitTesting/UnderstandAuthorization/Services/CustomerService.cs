...
namespace BankingAPI.Services
{
    public class CustomerService : ICustomerInteract, IAuthenticationService
    {
        ...
        public LoginResponse Login(LoginRequest request)
        {
            ...
            var allCustomer = _customerRepository.GetAll();
            string givenName  ="";

            if(allCustomer!=null){
                 givenName = allCustomer.Where(c => c.Username == request.Username).ToList()[0].Name;
            }
        ...
        private string GenerateAccountNumber()
        {
            ...
            var allAccountNumber = _accountRespository.GetAll();
            var maxAccountNumber = "000999001";
            if(allAccountNumber!=null){
                maxAccountNumber= allAccountNumber.OrderByDescending(a => a.AccountNumber).ToList()[0].AccountNumber;
            }
